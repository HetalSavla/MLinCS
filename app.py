...
# ------------------------------------------------------------------------------------------
#                                TAB 3 — Model Output Dashboard
# ------------------------------------------------------------------------------------------
with tab3:

    st.markdown("<div class='section-title'>📊 Model Output Dashboard</div>", unsafe_allow_html=True)

    st.info("Below sections are placeholders. Replace with your graphs and metrics later.")

    st.markdown("""
        ### 🔹 Confusion Matrix  
        *(You can embed heatmap using matplotlib)*  
    """)
    ...
    st.markdown("""
        ### 🔹 Feature Importance  
        *(Bar chart of your top contributing features)*  
    """)
...
with tab4:
    ...
    st.success("""
        ...
        **Best CV F1:** 0.53  
        **Test Accuracy:** 0.46  
        **Dataset:** Student online programming activity (Easy/Medium/Hard)  
    """)
